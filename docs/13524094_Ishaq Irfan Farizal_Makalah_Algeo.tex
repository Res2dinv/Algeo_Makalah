...
\usepackage{fancyhdr}
\pagestyle{fancy}
\lfoot{Makalah IF2123 Aljabar Linier dan Geometri - Teknik Informatika ITB-Semester I Tahun 2025/2026}
...
\caption{Source 1 (Fuji) \cite{img:fuji} transfers. From left: Original, Result s1t1 (Success), Result s1t2 (Failure), Result s1t3 (Failure)}
...
\caption{Source 3 (People) \cite{img:people} transfers. From left: Original, Result s1t1 (Failure), Result s1t2 (Failure), Result s3t3 (Semantic failure), Result s3t2 (Extreme darkening)}
...
The s1t1 transfer (shown in Figure \ref{fig:fuji_success_fail}, second image) produced visually coherent results because:
...
The author thanks the IF2123 Linear Algebra and Geometry course instructors at Bandung Institute of Technology for guidance in this research. The author also thanks their parents, friends and all the people that have helped them in this task. Lastly the author thanks ChatGPT, Claude Sonnet, Gemini 3 Pro for their helped in this research. 
...
\section*{Pernyataan}
    ...
    \includegraphics[width=0.5\linewidth]{src/ttd.png}\\
    Ishaq Irfan Farizal\\
    13524094
    \end{flushright}
